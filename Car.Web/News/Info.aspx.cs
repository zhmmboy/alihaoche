...
namespace Car.Web.News
{
    public partial class Info : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable dt = _newBll.GetNewById(nId);
            ...
            dtHot = CommonUtility.GetBaseListByCache(10, "nAddTime>DATEADD(day,-10,GETDATE()) order by nClicks desc", "news_" + ClassId + "_hot");
            ...
            dtTag = new TagsBLL().GetList(20, "classId='" + ClassId + "'  AND TType=2 order by tAddTime desc", true, "news_" + ClassId + "_tag", 120);
            ...
            dtRecommend = CommonUtility.GetBaseListByCache(10, "nclass1='" + ClassId + "' AND nAddTime>DATEADD(day,-30,GETDATE()) and nIsRecommand=1", "news_" + ClassId + "_recommend");
