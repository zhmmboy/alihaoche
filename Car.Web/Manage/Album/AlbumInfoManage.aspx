<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlbumInfoManage.aspx.cs" Inherits="Car.Web.Manage.Album.AlbumInfoManage" %>
            ...
            <asp:GridView ID="gvList" CssClass="cpxinxi" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="相片">
                        <ItemTemplate>
                            <a href="AlbumInfoManage.aspx?Id=<%#Eval("aId") %>">
                                <img src="<%# Eval("aiUrl")%>" /></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="相片描述">
                        <ItemTemplate>
                            <%# Eval("aiDesc")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="添加时间">
                        <ItemTemplate>
                            <%# Convert.ToDateTime(Eval("aiAddTime")).ToString("yyyy-MM-dd HH:mm")%>
                        </ItemTemplate>
                    </asp:TemplateField>
