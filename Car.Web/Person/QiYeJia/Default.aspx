<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Car.Web.Person.QiYeJia.Default" %>
...
<head>
    ...
    <title>企业家名录大全_企业家资料_企业家档案_阿里好车</title>
    <meta name="keywords" content="企业家名录大全、企业家资料、企业家档案">
    <meta name="description" content="收集并分享全球知名企业家名录大全、企业家资料、企业家档案。">
    ...
    <section class="container">
        <div class="content-wrap">
            <div class="content excerpts">
                <h3 class="title"><small class="pull-right">共收录：<%=totalCount %> 篇 企业家资料·档案</small><strong>最新发布</strong></h3>
