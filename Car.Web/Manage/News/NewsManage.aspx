<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsManage.aspx.cs" Inherits="Car.Web.Manage.News.NewsManage" ValidateRequest="false" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <div id="search" class="search">
            ...
            <div class="QuesAdd">
                <a href="/Manage/News/NewsAdd.aspx" class="btn_big">+添加</a><select id="selStatus" runat="server" class="ddlCss"><option value="1">可用</option>
                    <option value="2">不可用</option>
                </select>
                <asp:Button ID="btnSet" runat="server" Text="设置" CssClass="btn_big" OnClick="btnSet_Click" />
                ...
                <select name="selClass" id="selClass" runat="server" class="ddlCss">
                </select>
                <asp:Button ID="btnTransfer" runat="server" Text="转移分类" CssClass="btn_big" OnClick="btnTransfer_Click" />
            ...
            <asp:GridView ID="gvList" CssClass="cpxinxi" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="是否推荐">
                        <ItemTemplate>
                            <%# Convert.ToBoolean(Eval("nIsRecommand"))?"推荐":"不推荐"%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="/Manage/News/NewsAdd.aspx?Id=<%# Eval("nId")%>">编辑</a>
                            <a href="../../News/Info.aspx?Id=<%# Eval("nId")%>" target="_blank">预览</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
