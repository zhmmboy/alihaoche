<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnswerManage.aspx.cs" Inherits="Car.Web.Manage.Question.AnswerManage" %>
...
<body>
    <form id="form1" runat="server">
        <div id="search" class="search">
            ...
            <div class="QuesAdd">
                <a href="/Manage/Question/AnswerAdd.aspx?Id=<%=HttpContext.Current.Request.QueryString["Id"] %>" class="btn_big">+添加</a>
            </div>
        </div>
        <div id="main_table">
            <asp:GridView ID="gvList" CssClass="cpxinxi" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="/Manage/Question/AnswerAdd.aspx?Id=<%# Eval("qId")%>&aId=<%# Eval("aId")%>">编辑</a>
                            <a href="/Manage/Question/AnswerManage.aspx?Id=<%# Eval("aId")%>&action=del">删除</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
