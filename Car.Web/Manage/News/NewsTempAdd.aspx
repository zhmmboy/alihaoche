<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsTempAdd.aspx.cs" Inherits="Car.Web.Manage.News.NewsTempAdd" %>
        ...
        <div id="myTable">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="txtnFromUrl" runat="server" class="addInput" value="www.alihaoche.com" />
                        <span>转载请注明出处，尊重他人劳动成果。</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select id="selCarBrand" runat="server" class="ddlInputCss">
                            <option>请选择</option>
                        </select>
                    </td>
                </tr><tr>
...
Maximize">
                ...
                <tr>
                    ...
                    <td>
                       <input type="checkbox" id="chkChecked" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
