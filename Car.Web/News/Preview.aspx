<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Preview.aspx.cs" Inherits="Car.Web.News.Preview" %>
                ...
                <asp:Repeater ID="rptData" runat="server">
                    <ItemTemplate>
                        ...
                        <article class="article-content">
                            ...
                            <p class="post-copyright">此文由阿里好车编辑，未经允许不得转载：<a href="http://www.alihaoche.com/">阿里好车</a> » <a href="http://www.alihaoche.com/news/<%#Eval("nId") %>.html"><%#Eval("nTitle") %></a></p>
                        </article>
                    </ItemTemplate>
                </asp:Repeater>
                ...
                <div class="relates">
                    ...
                    <ul>
                       <%-- <asp:Repeater ID="rptRecommend" runat="server">
                            <ItemTemplate>
                                <li><a href="http://www.alihaoche.com/news/<%#Eval("nId") %>.html">
