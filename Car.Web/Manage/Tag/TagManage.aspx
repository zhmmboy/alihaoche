<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TagManage.aspx.cs" Inherits="Car.Web.Manage.Tag.TagManage" %>
...
<body>
    <form id="form1" runat="server">
        <div id="search" class="search">
            ...
            <div class="QuesAdd">
                <a href="/Manage/Tag/TagAdd.aspx" class="btn_big">+添加</a>
            </div>
        </div>
        <div id="main_table">
            <asp:GridView ID="gvList" CssClass="cpxinxi" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="添加时间">
                        <ItemTemplate>
                            <%# Convert.ToDateTime(Eval("tAddTime")).ToString("yyyy-MM-dd HH:mm")%>
                        </ItemTemplate>
                    </asp:TemplateField>
