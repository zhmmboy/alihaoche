<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionAdd.aspx.cs" Inherits="Car.Web.Manage.Question.QuestionAdd" %>
        ...
        <div id="myTable">
            <table cellpadding="0" cellspacing="0">
                <tr class="hui">
                    ...
                    <td>
                          <input type="text" id="txtAsker" runat="server" class="addInput"
                            value="" maxlength="100" />
                    </td>
                </tr>
                <tr>
