<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Car.Web.News.WangLuoHongRen.Default" %>
...
<head>
    ...
    <title>网络红人新闻_校花新闻_模特新闻_网络红人资讯_阿里好车</title>
    <meta name="keywords" content="网络红人新闻、校花新闻、模特新闻、网络红人资讯">
    <meta name="description" content="收集并分享全球网络红人新闻、校花新闻、模特新闻、网络红人资讯。">
    ...
    <section class="container">
        <div class="content-wrap">
            <div class="content excerpts">
                <h3 class="title"><small class="pull-right">共收录：<%=totalCount %> 篇 网络红人热点·资讯。</small><strong>最新发布</strong></h3>
                    ...
                    <asp:Repeater ID="rptHot" runat="server">
                        <ItemTemplate>
                            <li class="item-<%#Container.ItemIndex+1 %>"><a target="_blank" href="http://www.alihaoche.com/news/<%#Eval("cEnName") %>/<%#Eval("nId") %>.html">
                                <img data-src="http://www.alihaoche.com/<%#Eval("nTitlePic").ToString().Replace("../","") %>" class="thumb" src="http://www.alihaoche.com/<%#Eval("nTitlePic") %>" style="display: block;" alt="<%#Eval("nTitle") %>"><h2><%#Eval("nTitle") %></h2>
