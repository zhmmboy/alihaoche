<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Car.Web.Person.MingXing.Default" %>
...
<head>
    ...
    <title>明星个人资料_明星库_明星档案_阿里好车</title>
    <meta name="keywords" content="中国大陆明星、中国港澳台明星、欧美明星、日韩明星、明星库、明星个人资料、明星档案、明星简历">
    <meta name="description" content="收集并分享中国大陆明星、中国港澳台明星、欧美明星、日韩明星、艺人的个人资料。">
    ...
    <section class="container">
        <div class="content-wrap">
            <div class="content excerpts">
                <h3 class="title"><small class="pull-right">共收录：<%=totalCount %> 篇 明星资料·档案</small><strong>最新发布</strong></h3>
