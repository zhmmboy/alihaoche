<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Car.Web.News.MingXing.Default" %>
...
<head>
    ...
    <title>娱乐八卦新闻_明星新闻_明星绯闻_明星事件_明星资讯_阿里好车</title>
    <meta name="keywords" content="娱乐八卦新闻、明星新闻、明星绯闻、明星事件、明星资讯">
    <meta name="description" content="收集并分享全球明星娱乐八卦新闻、明星新闻、明星绯闻、明星事件、明星资讯。">
    ...
    <section class="container">
        <div class="content-wrap">
            <div class="content excerpts">
                <h3 class="title"><small class="pull-right">共收录：<%=totalCount %> 篇 明星热点·资讯。</small><strong>最新发布</strong></h3>
