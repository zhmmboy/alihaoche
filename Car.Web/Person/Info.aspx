<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info.aspx.cs" Inherits="Car.Web.Person.Info" %>
...
<body class="single single-post postid-14297 single-format-standard" data-navto="person">
    <!--Include Header-->
    ...
    <section class="container">
            ...
            <div class="content">
                <asp:Repeater ID="rptData" runat="server">
                    <ItemTemplate>
                        <header class="article-header">
                            <h1 class="article-title"><a href="http://www.alihaoche.com/person/<%#Eval("pId") %>.html"><%#Eval("pCnName") %></a></h1>
                            <div class="article-meta">
                                <time><%#Convert.ToDateTime(Eval("pAddTime")).ToString("yyyy-MM-dd HH:mm") %></time><span class="item">小编：<a href="http://www.alihaoche.com/">阿里好车</a></span>
                                <span class="item">分类：<%#Eval("cName") %></span>
                                <span class="item post-views">阅读(<%#Eval("pClicks") %>)</span>
                                <span class="item"></span>
                            </div>
                        </header>
                        <article class="article-content">
                            <%#Eval("pIntroduce") %>
                            <p class="article-tags"><strong>继续阅读：</strong><%=TagsStr %></p>
                            <p class="post-copyright">此文由阿里好车编辑，未经允许不得转载：<a href="http://www.alihaoche.com/">阿里好车</a> » <a href="http://www.alihaoche.com/person/<%#Eval("pid") %>.html"><%#Eval("pCnName") %>：<%#Eval("pJob") %></a></p>
                        </article>
                        <div class="article-social">
                            <a href="javascript:;" class="action action-like"  data-pid="<%#Eval("pid") %>" evt="like" evttype="person"><i class="glyphicon glyphicon-thumbs-up"></i>我觉得很赞 (<span><%#TotalZan %></span>)</a>
                ...
                <div class="relates">
                    ...
                    <ul>
                        <asp:Repeater ID="rptAround" runat="server">
                            <ItemTemplate>
                                <li><a href="http://www.alihaoche.com/person/<%#Eval("pId") %>.html">
                                    <img data-src="http://www.alihaoche.com/<%#Eval("pPhoto").ToString().Replace("../","") %>" class="thumb" src="http://www.alihaoche.com/<%#Eval("pPhoto").ToString().Replace("../","") %>" alt="<%#Eval("pCnName") %>:<%#Eval("pJob") %>"><%#Eval("pCnName") %></a></li>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ul>
                </div>
                ...
                <div id="postcomments">
                    <ol class="commentlist">
                      <%--  <li class="comment even thread-even depth-1" id="comment-11193">
                            <span class="comt-f">#1</span><div class="comt-avatar">
                            <img alt="" data-src="http://www.alihaoche.com/res/image/avatar-default.png" class="avatar avatar-50 photo" height="50" width="50" src="http://www.alihaoche.com/res/image/avatar-default.png" style="display: block;">
                        </div>
                            <div class="comt-main" id="div-comment-11193">
                                现在知道咯<div class="comt-meta"><span class="comt-author">励志青年</span><time>12-20</time><a class="comment-reply-link" href="javascript:;" onclick="return addComment.moveForm(&quot;div-comment-11193&quot;, &quot;11193&quot;, &quot;respond&quot;, &quot;14297&quot;)">回复</a></div>
                            </div>
                        </li>--%>
                        <!-- #comment-## -->
                    </ol>
            ...
            <div class="speedbar">
              <%--  <ul class="speedbar-menu">
                ...
                <div class="speedbar-weixin">
                    <h5>微信关注“阿里好车”<br>
                        找名人资料就上阿里好车</h5>
                    <img src="http://www.alihaoche.com/res/image/weixin-qrcode.jpg" alt="微信关注“阿里好车” 找名人就上阿里好车！">
                </div>
            </div>
        </aside>
        ...
        <aside class="sidebar">
            <div class="widget article-social">
                <a href="javascript:;" class="action action-like" data-pid="<%=this.Request.QueryString["id"] %>" evt="like" evttype="person"><i class="glyphicon glyphicon-thumbs-up"></i>可以试试 (<span><%=TotalZan %></span>)</a>
                <div class="action-share bdsharebuttonbox bdshare-button-style0-24" data-bd-bind="1419398361060">
                    <strong>分享到：</strong>
                    <a class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a class="bds_weixin bdsm" data-cmd="weixin" title="分享到微信"></a><a class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a class="bds_sqq bdsm" data-cmd="sqq" title="分享到QQ好友"></a><a class="bds_renren" data-cmd="renren" title="分享到人人网"></a><a class="bds_douban" data-cmd="douban" title="分享到豆瓣网"></a>
                    <span class="bds_count" data-cmd="count" title="累计分享0次">0</span>
            ...
            <div class="widget widget_ui_tags">
                ...
                <div class="items">
                    <asp:Repeater ID="rptTag" runat="server">
                        <ItemTemplate>
                            <a href="http://www.alihaoche.com/tag/<%#Server.UrlEncode(Eval("tName").ToString()) %>.html" title="“<%#Eval("tName") %>”相关文章"><%#Eval("tName") %></a>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
            </div>
